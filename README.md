...
## Data Base
Collected images and annotation in roboflow. Data set link: https://app.roboflow.com/hsu-myat-thein-lwin/shahed_fixedwingdrone_detection/7. More than 1000 images: different weather conditions, environment, angles and distance, use Bounding box for annotation (.zip file also in file)
Argumentations used
